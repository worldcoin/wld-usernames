...
CREATE INDEX CONCURRENTLY IF NOT EXISTS username_trgm_with_pictures_idx ON names USING GIST (username gist_trgm_ops(siglen=256)) INCLUDE (address, profile_picture_url, minimized_profile_picture_url);
